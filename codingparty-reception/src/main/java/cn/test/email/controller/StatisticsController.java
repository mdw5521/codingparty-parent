...
public class StatisticsController {
	...
	@Autowired
	private StatisticsService statisticsAService;
	...
	public List<QuestionType> getErrorCount(Users users) {
		...
		List<QuestionType> types = statisticsAService.getErrorCount(users);
	...
	public List<QuestionType> getQuestionCount(Users users) {
		...
		List<QuestionType> questionCount = statisticsAService.getQuestionCount();
...
*/
	...
	public String getQuestion(Model model,Integer rank,HttpSession session,Integer uid) {
