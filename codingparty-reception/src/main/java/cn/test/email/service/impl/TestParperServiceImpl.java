...
public class TestParperServiceImpl implements TestPaperService {
	 ...
	 */
	@Override
	public List<TestPaper> selectAllTestPaper(SeedPaper sp) throws Exception {
		// TODO Auto-generated method stub
		return testParperMapper.selectAll(sp);
	}
	 ...
	 */
	@Override
	public List<TestPaper> selectTestPaperById(Integer rank) {
		// TODO Auto-generated method stub
		return testParperMapper.selectTestPaperById(rank);
	}
