...
public class LoginInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(!reqUri.contains("/login.do") && !reqUri.contains("/registerFindUser.do") && !reqUri.contains("/home.do") && !reqUri.contains("/dologin.do")
				&& !reqUri.contains("/register.do")&& !reqUri.contains("/toMyExam.do") && !reqUri.contains("/doregister.do") && !reqUri.contains("/user/findStudentAll.do")&& !reqUri.contains("/user/fa.do")){
