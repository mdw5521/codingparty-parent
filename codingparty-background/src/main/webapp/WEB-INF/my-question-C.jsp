...
<input type="hidden" id="did" name="did" value="59bf94638d9ede67f839406b">
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid container" style="height: 60px; min-height: 60px">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse" align="left">
                ...
                <ul class="nav navbar-nav userLinks navbar-right hidden-xs" style="margin-right:10px;">
                    ...
                    <li class="dropdownLoginOut">
                        <a id="aemail" href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-cogs"></i>
                           <p style="margin-right: 20px;font-family: 楷体;color: red;font-size: 25px;">${loginUser.name }</p>
...
<div class="plist test_public  prof_t ng-scope">
    ...
    <div class="sp_Tcen">
        ...
        <div class="sp_Tcb1 addpap_t9 questype">
            <span>题型：</span>
            <ul>
                <li class="A_N_P_Ali" id="1"><a href="${pageContext.request.contextPath}/shoudong.do?type=1">单选题</a><em></em></li>
                <li class="A_N_P_Ali" id="2"><a href="${pageContext.request.contextPath}/shoudong.do?type=3">多选题</a><em></em></li>
                <li class="" id="3">判断题<em></em></li>
                <li class="A_N_P_Ali" id="4"><a href="${pageContext.request.contextPath}/shoudong.do?type=2">填空题</a><em></em></li>
        ...
        <!---------------------------------------------------------------------------->
   <form id="questionForm" action="${pageContext.request.contextPath}/addDo.do" method="post">
        ...
        <div class="sp_Tcb-ti parse parse-l" style="margin: 0px;height: 70px;padding-left:70px;display: none">
            ...
            <!--<a class="updown" href="javascript:void(0)">请上传题解</a>-->
        </div>
        <!--------------------------------->
                            ...
                            <td>
                                <div class="content">
                                    <div  class="addQues-optextarea-div" contenteditable="true">
                                    	<input type="text" name="options" style="width:100%;height:30px;background-color:orange;">
                                    </div>
                                </div>
                            </td>
                    ...
                    <table>
                        <tbody><tr>
                            ...
                            <td>
                                <div class="content">
                                    <div class="addQues-optextarea-div" contenteditable="true">
                                    	<input type="text" name="options" style="width:100%;height:30px;background-color:aqua;">
                                    </div>
                                </div>
                            </td>
                    ...
                    <table>
                        <tbody><tr>
                            ...
                            <td>
                                <div class="content">
                                    <div class="addQues-optextarea-div" contenteditable="true">
                                    	<input type="text" name="options" style="width:100%;height:30px;background-color:yellow;">
                                    </div>
                                </div>
                            </td>
                    ...
                    <table>
                        <tbody><tr>
                            ...
                            <td>
                                <div class="content">
                                    <div class="addQues-optextarea-div" contenteditable="true">
                                    	<input type="text" name="options" style="width:100%;height:30px;background-color:olive;">
                                    </div>
                                </div>
                            </td>
     ...
     <div class="diffcult nanduBox" style="margin-top: 0px;margin-bottom: 20px;" value="">
	         <span class="time-noline"><b class="start"> * </b> 难度： 
           ...
           <span class="time-noline"><b class="start"> * </b> 试题标签： 
            	<select name="label" style="background-color: silver;width: 150px;height: 35px;font-size: 23px;font-family: 楷体;">
        ...
        <div class="submitBtns">
            <a href="javascript:document.getElementById('questionForm').submit();" ng-click="warning()">提交</a>
        </div>
