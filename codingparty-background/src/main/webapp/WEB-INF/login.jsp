		...
		<div class="userCnt">
			<div class="loginCnt">
				...
				<div class="login-box">
					<ul>
						<li>
							<input type="text" id="phone" name="name" class="login-text input" placeholder="请输入管理员账号" maxlength="11">
						</li>
						<li>
							<input type="password" id="pwd" name="pass" class="login-text input" placeholder="请输入密码" maxlength="20">
						</li>
						<li class="login-error" id="err_msg" style="display: none;"><i></i>账号或密码输入错误</li>
