                    ...
                    <div class="set_p_r-5cbt viewPaperTitle">
                        <div class="fl"> <span style="float: left" class="ng-binding">${vs.count}．</span>
                          <span ng-if="pq.questype==1" style="float: left;color: #2abcb9;font-weight: bolder" class="ng-scope">填空题</span><!-- end ngIf: pq.questype==1 -->
                            ...
                            　<span>|</span>　</div>
                        <div style="overflow: hidden">
                        <div class="fl f6 ng-binding" style="width:100%" ng-bind-html="pq.questitle | trustHtml"><p>${i.title}</p><p>
</p></div>
                        </div>
                    </div>
			<ul><li>
                             ...
                             <textarea name="" cols="100" rows="2" style="background-color:#EE1289; ">
...
if (confirm(msg) == true) {
		...
		function _countExam(){
			if(flags){
				...
				document.getElementById("countExamForm").submit();
			}else{
				alert("你还未提交试卷！");
			}
		}
