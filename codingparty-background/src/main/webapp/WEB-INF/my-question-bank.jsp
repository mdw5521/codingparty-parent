...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-animate-anchor{position:absolute;}</style>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/css4.css">
    ...
    <script src="${pageContext.request.contextPath}/js/jquery-3.2.1.min.js" type="text/javascript"></script>
 	<script src="${pageContext.request.contextPath}/js/mask.js" type="text/javascript"></script>
        ...
        <div class="container-fluid container" style="height: 60px; min-height: 60px">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                ...
                <li><a href="${pageContext.request.contextPath}/toMyExam.do"><i
							class="icon-plus-sign"></i>添加试题</a></li>
				</ul>  
                <ul class="nav navbar-nav userLinks navbar-right hidden-xs" style="margin-right:10px;">
                    ...
                    <li class="dropdownLoginOut">
                        <a id="aemail" href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-cogs"></i>
                           <p style="margin-right: 20px;font-family: 楷体;color: red;font-size: 25px;"></p>
...
<div class="plist test_public  prof_t ng-scope">
    <div class="topbt topbt-2">
        <h3>添加试题</h3>
        <div class="pronext"><a href="${pageContext.request.contextPath}/quit.do" style="font-size: 15px;color: red;">返回</a></div>
    </div>
    ...
    <div class="sp_Tcen">
        ...
        <div class="sp_Tcb1 addpap_t9 questype">
            <span>题型：</span>
            <ul>
               <c:forEach items="${questionsType }" var="questiontype">
                   <li class="" ><a  onclick="_add(${questiontype.id}+','+'${questiontype.type}')">${questiontype.type}</a><em></em></li>
               </c:forEach>
                
                <!-- <li class="" id="2">多选题<em></em></li>
...
<div class="upon-mask" id="ask-modal">
	<h3>
	 ...
	 <form id="from1">
	    <input type="hidden" value="" id="questiontypeid" name="type">
	    <input type="hidden" value="" id="questiontypeid11">
		<input type="hidden" value="${pid }" name="pid">
		<input id="questionTitle" type="text" name="answer" placeholder="写下你的答案">
		<input type="hidden" id="questionContent">
		<div>标签：
		<select name="label">
		<c:forEach items="${label }" var="la">
		<option value="${la.lid }">${la.label }</option>
		</c:forEach>
		</select> 
		困难程度：
		<select name="rank">
		...
		<textarea name="title" id="questionContent" style="height: 95px;width: 700px;" placeholder="写下你的题干"></textarea>
		
		<div>选项：</div>A：
		<input id="topicNameString" type="text" name="options" placeholder="写下你的选项">
		</br> B：<input id="topicNameString" type="text" name="options" placeholder="写下你的选项">
		</br> C：<input id="topicNameString" type="text" name="options" placeholder="写下你的选项">
		</br> D：<input id="topicNameString" type="text" name="options" placeholder="写下你的选项">
		<button type="button" onclick="_submit()">保存</button>
...
<!-- 多选弹框 -->
 <div class="mask" id="coverId2"></div>
<div class="upon-mask" id="ask-modal2">
	<h3>
		<span>添加多选试题</span>
		<span class="close-mask" onclick="_hidden2()">×</span>
	</h3>
	 <form id="from2">
	    <input type="hidden" value="" id="questiontypeid2" name="type">
	     <input type="hidden" value="" id="questiontypeid22">
	    <input type="hidden" value="${pid }" name="pid">
		<input id="questionTitle" type="text" name="answer" placeholder="写下你的答案">
		<div>标签：
		<select name="label">
		...
		<textarea name="title" style="height: 95px;width: 700px;" placeholder="写下你的题干"></textarea>
		<input type="hidden" id="questionContent2">
		<div>选项：</div>A：
		<input id="topicNameString" type="text" name="options" placeholder="写下你的选项">
		</br> B：<input id="topicNameString" type="text" name="options" placeholder="写下你的选项">
		</br> C：<input id="topicNameString" type="text" name="options" placeholder="写下你的选项">
		</br> D：<input id="topicNameString" type="text" name="options" placeholder="写下你的选项">
		<button type="button" onclick="_submit2()">保存</button>
		<input type="reset" name="reset" style="display:none;"/>
	</form> 
...
<!-- 填空弹框 -->
 <div class="mask" id="coverId3"></div>
<div class="upon-mask" id="ask-modal3">
	<h3>
		<span>添加填空试题</span>
		<span class="close-mask" onclick="_hidden3()">×</span>
	</h3>
	
	 <form id="from3">
	    <input type="hidden" value="" id="questiontypeid3" name="type">
	     <input type="hidden" value="" id="questiontypeid33">
	    <input type="hidden" value="${pid }" name="pid">
		<input id="questionTitle" type="text" name="answer" placeholder="写下你的答案">
		<div>标签：
		<select name="label">
		...
		<div>题干：</div>
		<textarea name="title"  style="height: 95px;width: 700px;" placeholder="写下你的题干"></textarea>
		<input type="hidden" id="questionContent3">
		<button type="button" onclick="_submit3()">保存</button>
		<input type="reset" name="reset" style="display:none;"/>
	</form> 
</div>
...
<!-- 问答弹框 -->
 <div class="mask" id="coverId4"></div>
<div class="upon-mask" id="ask-modal4">
	<h3>
		<span>添加问答试题</span>
		<span class="close-mask" onclick="_hidden4()">×</span>
	</h3>
	
	 <form id="from4">
	    <input type="hidden" value="" id="questiontypeid4" name="type">
	   <input type="hidden" value="" id="questiontypeid44">
	    <input type="hidden" value="${pid }" name="pid">
		<input id="questionTitle" type="text" name="answer" placeholder="写下你的答案">
		<div>标签：
		<select name="label">
		...
		<div>题干：</div>
		<textarea name="title" style="height: 95px;width: 700px;" placeholder="写下你的题干"></textarea>
		<input type="hidden" id="questionContent4">
		<button  type="button" onclick="_submit4()">保存</button>
	    <input type="reset" name="reset" style="display:none;"/>
	</form> 
</div>
 ...
 <div align="center"><input type="button" onclick="location.href='${pageContext.request.contextPath}/saveQuestion.do?pid=${pid }'" style="width: 85px;height: 35px; background-color: pink;border-radius:10px;" value="提交"> </div>
<script language="javascript" type="text/javascript">
    lft = 'tkgl';
</script>
...
var id;
  function _add(aa){
	  ...
	  id=str[0];
	  var type=str[1];
	  //document.getElementById("div1").append("<div>111</div>");
	  var newchild = document.createElement("p");
      newchild.innerHTML = "<div><span id='span"+id+"'><h4>"+type+"</h4>(<input type='text' value='分值' style='width: 30px;'>:<input type='text' value='100' style='width: 30px;background-color: orange;'>) <input type='button' value='+' style='width: 40px;height:25px; background-color: pink;' onclick='tan("+id+")'></span></div>";
      document.getElementById("div1").appendChild(newchild);
  }
  
  function tan(id){
	    document.getElementById("questiontypeid").value=id;
	    if(id==1){
	    ...
	    if(id==2){
	    	document.getElementById("questiontypeid2").value=id;
			document.getElementById("ask-modal2").style.display="block";
			document.getElementById("coverId2").style.display="block";
		}
	    
	    if(id==3){
	    	document.getElementById("questiontypeid3").value=id;
			document.getElementById("ask-modal3").style.display="block";
			document.getElementById("coverId3").style.display="block";
		}
	    
	    if(id==4){
	    	document.getElementById("questiontypeid4").value=id;
			document.getElementById("ask-modal4").style.display="block";
			document.getElementById("coverId4").style.display="block";
		}
  ...
  function _hidden2(){
	   ...
	   document.getElementById("ask-modal2").style.display="none";
		document.getElementById("coverId2").style.display="none"; 
  }
  
  function _hidden3(){
	  document.getElementById("ask-modal3").style.display="none";
		document.getElementById("coverId3").style.display="none"; 
  }
  
  function _hidden4(){
	  document.getElementById("ask-modal4").style.display="none";
	  document.getElementById("coverId4").style.display="none"; 
  }
  
  function _submit(){
	  var ser=$('#from1').serialize();
	   $.ajax({
          type: "POST",
          ...
          data:ser,    // 你的formid
           ...
           success: function(data){
        	  var newchild = document.createElement("p");
        	  $("#questionContent").val(data.title);
        	  $("#questiontypeid11").val(data.type);
        	  newchild.innerHTML="<div style='font-size: 15px;' id='div"+data.title+"'>"+data.title+" <span style='width: 50px;height: 20px;float:right;'><input value='×' type='button' onclick='_deleteQuestion();' style='width:35px;height:18px;background-color: red;border-radius:10px;font-size: 15px;color:black;'></span></div> ";
        	  document.getElementById("span"+data.type+"").appendChild(newchild);
  ...
  function _submit2(){
	  var ser=$('#from2').serialize();
	    $.ajax({
          ...
          success:function(data){
        	  var newchild = document.createElement("p");
        	  $("#questionContent2").val(data.title);
        	  $("#questiontypeid22").val(data.type);
        	  newchild.innerHTML="<div style='font-size: 15px;' id='div"+data.title+"'>"+data.title+" <span style='width: 50px;height: 20px;float:right;'><input value='×' type='button' onclick='_deleteQuestion2();' style='width:35px;height:18px;background-color: red;border-radius:10px;font-size: 15px;color:black;'></span></div> ";
        	  document.getElementById("span"+data.type+"").appendChild(newchild);
  ...
  function _submit3(){
	  var ser=$('#from3').serialize();
	   $.ajax({
          type: "POST",
          url:"${pageContext.request.contextPath }/addQuestion.do",
          data:ser,    // 你的formid
           success: function(data){
        	   $("#questionContent3").val(data.title);
         	  $("#questiontypeid33").val(data.type);
        	  var newchild = document.createElement("p");
        	  newchild.innerHTML="<div style='font-size: 15px;' id='div"+data.title+"'>"+data.title+" <span style='width: 50px;height: 20px;float:right;'><input value='×' type='button' onclick='_deleteQuestion3();' style='width:35px;height:18px;background-color: red;border-radius:10px;font-size: 15px;color:black;'></span></div> ";
        	  document.getElementById("span"+data.type+"").appendChild(newchild);
  ...
  function _submit4(){
	  var ser=$('#from4').serialize();
	   $.ajax({
          type: "POST",
          url:"${pageContext.request.contextPath }/addQuestion.do",
          data:ser,    // 你的formid
           success: function(data){
        	  $("#questionContent4").val(data.title);
         	  $("#questiontypeid44").val(data.type);
        	  var newchild = document.createElement("div");
        	  newchild.innerHTML="<div style='font-size: 15px;' id='div"+data.title+"'>"+data.title+" <span style='width: 50px;height: 20px;float:right;'><input value='×' type='button' onclick='_deleteQuestion4();' style='width:35px;height:18px;background-color: red;border-radius:10px;font-size: 15px;color:black;'></span></div> ";
        	  document.getElementById("span"+data.type+"").appendChild(newchild);
  ...
  function _deleteQuestion(){
	  var a= $("#questionContent").val();
	  var b= $("#questiontypeid11").val();
		   $.ajax({
	          type: "POST",
  ...
  function _deleteQuestion2(){
  var a= $("#questionContent2").val();
  var b= $("#questiontypeid22").val();
	   $.ajax({
          type: "POST",
          url:"${pageContext.request.contextPath }/deleteQuestion.do",
          data:{
  ...
  function _deleteQuestion3(){
	  var a= $("#questionContent3").val();
	  var b= $("#questiontypeid33").val();
		   $.ajax({
	          type: "POST",
	          url:"${pageContext.request.contextPath }/deleteQuestion.do",
	          data:{
  ...
  function _deleteQuestion4(){
	  var a= $("#questionContent4").val();
	  var b= $("#questiontypeid44").val();
		   $.ajax({
	          type: "POST",
	          url:"${pageContext.request.contextPath }/deleteQuestion.do",
	          data:{
