...
<div class="plist test_public myPositionList ng-scope">
	...
	<div>
		<div>
			<div class="act">
				<span style="font-size:20px;">选择录入方式</span></div>
			<div>
			<!-- <li ng-if="pp.fromPaperId==undefined" class="ng-scope"> -->
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a class="add able" href="${pageContext.request.contextPath}/shoudong.do?type=${type}">手动录入</a>
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a class="add able" href="${pageContext.request.contextPath}/addExcle.do?type=${type}">excle录入</a>
			</div>
			</div>
		</div>
		</center>
