								...
								<div class="apa_le my_ques-apa_le">
									<div class="apa_le-bt">
										...
										<!-- <div class="apa_le-btf">
											<p>题库总题数</p>
											<p>
												<em ng-bind="quesCount" class="ng-binding"></em>题
											</p>
										</div> -->
									</div>

									<%-- <div class="apa_le-tj">
										<a href="${pageContext.request.contextPath}/add.do?sid=${tqv.sid}&type=1">添加单选题</a>
									</div> --%>
									<%-- <div class="apa_le-tj">
										<a href="${pageContext.request.contextPath}/add.do?sid=${tqv.sid}&type=2">添加填空题</a>
									</div>
									<div class="apa_le-tj">	
										<a href="${pageContext.request.contextPath}/add.do?sid=${tqv.sid}&type=3">添加多选题</a>
									</div> --%>
								</div>
									...
									<div class="apa_ri-two">
										<div class="apa_ri-qx">
											...
											<span class="mOperation-btn" style="float: left;"> <a
												href="javascript:document.getElementById('selectAdd').submit()" ng-click="delQues()"
												class="active btn">添加</a>
											</span>
											<div class="guidebar quesBar"
											 ...
											 <span>共<em style="font-weight: bolder"
												class="ng-binding"> </em>项查询结果
											</span>
										</div>
					<form id="selectAdd" action="${pageContext.request.contextPath}/selectAdd.do" method="post">
								<input type="hidden" name="pid" value="${pid}">
								<c:forEach items="${questionlist}" var="teq" varStatus="vs">
										<div class="quesesBox">
												...
												<div ng-if="q.questype==4 || q.questype==5"
													...
													<div class="apa_ri-cenbt">
														...
														<span class="questype ng-scope" ng-if="q.questype==5"
															style="color: #2abcb8; font-weight: bolder;">
															<c:if test="${teq.type==1}">单选题</c:if>
															<c:if test="${teq.type==2}">多选题</c:if>
															<c:if test="${teq.type==3}">填空题</c:if>
															<c:if test="${teq.type==4}">简答题</c:if>
															</span>
													...
													<ul class="apa_ri-cenul">
														<div class="answerBox">
															...
															<pre style="color: #29bdb9; word-break: break-all; width: 50%"	ng-bind-html="q.answer | trustHtml" class="ng-binding">
																<p align="left">
																A:<input type="radio" name="option" value="A">${teq.ops[0]}
																B:<input type="radio" name="option" value="B">${teq.ops[1]}
																C:<input type="radio" name="option" value="C">${teq.ops[2]}
																D:<input type="radio" name="option" value="D">${teq.ops[3]}
																</p>
