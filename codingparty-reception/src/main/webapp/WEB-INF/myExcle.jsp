...
<div class="plist test_public myPositionList ng-scope">
    ...
    <div class="con_top addNewPaper">
        ...
        <span><a href="/xueze.do?type=1" ng-click="newPaper()">+ 录入试题</a></span>
	...
	<div >
		<div >
			<div class="act">
			<div class="text"><span style="font-size:25px;font-weight:bold">EXCEL批量录入考试试题：</span></p></br>
				<span style="font-size:20px;"></span></div>
			<div>
			<form id="import_form" class="form-horizontal" action="${pageContext.request.contextPath}/luExcle.do" method="post" enctype="multipart/form-data">  
		      <div class="form-group">  
		          <input type="file" name="filename" id="file" required class="input-1"  >  
		      </div>  
		     <div class="form-group">  
		    	...
		    	excle单选题格式：第一行是题，第二行为选项，第三行为答案，第四行为题型；<br>
		    	excle多选题格式：第一行是题，第二行为选项，第三行为答案，第四行为题型；<br>
		    	1为单选题，3为多选题；<br>
		    	答案与答案之间用中文“；”号隔开；<br>
		    	文件的后缀位xls<br>
   ...
   <!-- 新建试卷 -->
		...
		<!-- 自动导入试卷 -->
		  <div id="zds" class="white_content"> 
			...
			<div><h4 style="color: red;font-family: 楷书; font-size: 25px;" >自动导入试卷</h4></div>
