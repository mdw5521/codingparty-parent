                    ...
                    <li class="dropdownLoginOut">
                        <a id="aemail" href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-cogs"></i>
                             ...
                             <p style="margin-right: 35px;color:silver; font-size: 15px;"></p>
                        ...
                        <li style="text-align: center;width: 110px;height: 32px;"><a style="width:108px;padding: 8px 0px;font-size: 12px;" href="${pageContext.request.contextPath}/tuichu.do" class="logOut" data-href="${pageContext.request.contextPath}/tuichu.do"><img src="${pageContext.request.contextPath}/files/exit.png" style="width: 14px;position: relative;left: -10px;top: -2px;">&nbsp;退出登陆</a></li></ul>
                    </li>
...
<div class="plist test_public myPositionList ng-scope">
    ...
    <div class="con_top addNewPaper">
        ...
        <%-- <span> <a href="${pageContext.request.contextPath}/showParper.do" >查看做题记录</a></span>
        <span style=" background-color:gray; width:15px;">|</span> --%>
       
        <span> <a href="${pageContext.request.contextPath}/xuanze.do" >+录入试题</a></span>
        <span style=" background-color:gray; width:15px;">|</span>
       <%--  <span> <a href="${pageContext.request.contextPath}/user/findStudentAll.do" >🔍查看学生</a></span>
        <span style=" background-color:gray; width:15px;">|</span> --%>
        <%-- <span> <a href="${pageContext.request.contextPath}/toMenu.do" >专题练习</a></span>
        <span style=" background-color:gray; width:15px;">|</span> --%>
        
         <span style="text-align: center;" id="addSiama"><a href="javaScript:void(0)" ng-click="newPaper()" onclick="_xj()">+ 新建试卷</a></span>
        
        <span style=" background-color:gray; width:15px;">|</span>
        <span style="text-align: center;" id="addSiama"><a href="javaScript:void(0)" ng-click="newPaper()" onclick="_zd()">自动生成试卷</a></span>
...
<c:forEach items="${testPaper}" var="p">
               ...
               <%--  <td width="100"><span style="font-weight: bolder;font-size: 14px;" class="ng-binding">${p.seednum}</span> 卷</td> --%>
                ...
                <td class="plist-x">
                    <ul class="testPaper-list">
                        <li><a ng-click="addPaper(p,$event)" class="addPaper" onclick="_tc(${p.id})">添加试题</a></li>
                        <li><a ng-click="addPaper(p,$event)" href="${pageContext.request.contextPath}/yl.do?id=${p.id}&pname=${p.pname}&time=${p.time}" class="addPaper">预览试卷</a></li>
                    </ul>
                </td>
            </tr>
            </tbody>
   ...
   <!-- 新建试卷 -->
		  <div id="xjs" class="white_content"> 
			<a style="float: right;" href = "javascript:void(0)" onclick = "document.getElementById('xjs').style.display='none';document.getElementById('xjx').style.display='none'">关闭</a>
			<div><h4 style="color: red;font-family: 楷书; font-size: 25px" >新建试卷</h4></div>
			
				<div align="center" style="background-color: pink;font-size:20px;height: 140px;border-radius:10px;">
				试卷名称:<input type="text" id="name"><br>
				试卷时长:<input type="text" id="shi"><br>
				<input type="button" onclick="_tj()" value="提交" >
				</div>
			    <div class="content4"  contenteditable="true" id="rcontent"  title=""></div>
			</div>
		</div> 
		<div id="xjx" class="black_overlay"></div> 
		
		
		
		<!-- 自动导入试卷 -->
		  <div id="zds" class="white_content"> 
			<a style="float: right;" href = "javascript:void(0)" onclick = "document.getElementById('zds').style.display='none';document.getElementById('zdx').style.display='none'">关闭</a>
			<div><h4 style="color: red;font-family: 楷书; font-size: 25px;" >自动生成试卷</h4></div>
				<div align="center" style="background-color: pink;border-radius:10px;">
				
				试卷名称:<input type="text" id="name1"><br>
				试卷时长:<input type="text" id="shi1"><br>
				单选题:2道<br>
				多选题:2道<br>
				填空题:1道<br>
				简答题:1道<br>
				
				<input type="button" onclick="_sc()" value="一键生成">
				</div>
			    <div class="content4"  contenteditable="true" id="rcontent"  title=""></div>
			</div>
		</div> 
		<div id="zdx" class="black_overlay"></div>
   
   
	<!-- 弹出框 -->
		<div id="light" class="white_content">
			<a style="float: right;color: black;" href="javascript:void(0)"
				onclick="document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'">关闭</a>

     <div><h4 style="color: red;font-family: 楷书; font-size: 25px" >请选择添加试题方式</h4></div>
             
             <a href="javascript:void(0)" onclick="_addquestions()">
        				 <div style="width: 180px;height: 120px;background-color: pink;position:fixed; top:220px; left: 410px; border-radius:10px;">
                      <font style="color: red; font-family: 楷书; font-size: 20px; position:fixed; top:260px; left: 440px;">手动添加试题</font> 
        		 </div>
      		  </a>
      
           <a href="javascript:void(0)" onclick="_selectquestions()">
    		<div style="width: 180px;height: 120px;background-color: pink;position:fixed; top:220px; left: 690px;border-radius:10px;">
    		<font style="color: red; font-family: 楷书; font-size: 20px; position:fixed; top:260px; left: 720px;">
    		从题库中选题
    		</font>
    	 </div>
    	 </a>
...
function _addquestions(){
	location.href="${pageContext.request.contextPath}/add.do?id="+pid+"&type=1"
}

function _selectquestions(){
	location.href="${pageContext.request.contextPath}/selectquestions.do?id="+pid;
}


function _xj(){
	document.getElementById("xjs").style.display="block";
	document.getElementById("xjx").style.display="block";
	
}
function _zd(){
	document.getElementById("zds").style.display="block";
	document.getElementById("zdx").style.display="block";
...
function _tj(){
	...
	location.href="${pageContext.request.contextPath}/addti.do?name="+name+"&shi="+shi;
	
}
function _sc(){
	var name=document.getElementById("name1").value;
	var shi=document.getElementById("shi1").value;
	location.href="${pageContext.request.contextPath}/sc.do?name="+name+"&shi="+shi;
